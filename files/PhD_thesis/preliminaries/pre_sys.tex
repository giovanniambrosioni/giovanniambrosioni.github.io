\section{Systems of categories with increasing accuracy}\label{se:sys}\label{s:sys-tpc}
...
\subsection{The case of PC's} \label{sb:sys-pc}
...
\subsection{Functors of systems of PC's} \label{sbsb:func-sys-pc}
...
\subsection{The case of TPC's} \label{sb:sys-tpc} A system of TPC's
...
\subsection{Systems of filtered
...
\subsection{Modules and Yoneda embeddings of
...
\subsection{Systems of PC's associated with systems of
...
\subsection{Systems with a coherent base of
...
\subsection{Homotopy systems} \label{sbsb:homotopy-sys}
...
\subsection{Invariants of systems} \label{sb:sys-inv} Systems of
